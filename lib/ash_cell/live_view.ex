...
defmodule AshCell.LiveView do
  ...
  defp rebind_params(_params, _uri, socket), do: {:cont, bind_now(socket, socket.assigns.tenant)}
  defp rebind_event(_event, _params, socket), do: {:cont, bind_now(socket, socket.assigns.tenant)}
