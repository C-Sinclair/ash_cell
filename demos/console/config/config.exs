...
config :demo, :ash_domains, [Demo.Global, Demo.Clinical]

config :demo, Demo.CellRepo, pool_size: 1, migration_lock: false

config :demo, :cell_dir, "priv/cells"

config :demo, :object_store,
